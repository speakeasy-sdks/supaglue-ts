...
export class ListOpportunitiesQueryParams extends SpeakeasyBase {
  /**
...
export class ListOpportunitiesHeaders extends SpeakeasyBase {
  /**
...
export class ListOpportunitiesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: ListOpportunitiesQueryParams;

  @SpeakeasyMetadata()
  headers: ListOpportunitiesHeaders;
}
