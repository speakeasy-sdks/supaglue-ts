 ...
 * Leads
 */
export class ListLeads200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "next" })
  next?: string;
  ...
  @SpeakeasyMetadata({ elemType: shared.Lead })
  @Expose({ name: "results" })
  @Type(() => shared.Lead)
  results?: shared.Lead[];
}

export class ListLeadsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
